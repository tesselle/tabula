...
| $$ R_{2} = \frac{S}{\log N} $$    | Odum *et al.* (1960) |
| $$ R_{3} = \frac{S}{\sqrt{N}} $$  | Menhinick (1964)*    |
| $$ R_{4} = \frac{S}{\log A} $$    | Gleason (1922)       |
Table: Richness measures (Bobrowsky & Ball 1989). *: implemented.

| Measure                           | Reference            |
|:----------------------------------|:---------------------|
| $$ \hat{S}_{1} = \alpha - \left[ \ln \left( 1 - x \right) \right] $$ | Fisher *et al.* (1943) |
...
| $$ \hat{S}_{6} = \frac{a N}{1 + b N} $$ | de Caprariis *et al.* (1976) |
| $$ \hat{S}_{7} = \sum_{i = 1}^{S} 1 - \frac{{N - N_i} \choose n}{N \choose n} $$ | Hurlbert (1971), Sander (1968)* |
Table: Rarefaction measures (Bobrowsky & Ball 1989). *: implemented.
