...
To demonstrate how to use these diversity functions we will use a dataset containing ceramic counts from the Mississippi region, originally published by @lipo2015.
...
```{r sample-size, fig.width=7, fig.height=7, fig.show='hold', out.width='50%'}
