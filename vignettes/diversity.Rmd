---
title: "Diversity measures calculation"
author: "N. Frerebeau"
date: "`r Sys.Date()`"
output:
...
Similarity between two samples $a$ and $b$ can be measured as follow. $a_i$ and $b_i$ denote the number of individuals in the $i$-th taxon, $i \in \left[ 1,n \right]$. $j$ denotes the number of taxa common to both samples: $j = \sum_{k = 1}^{n} a_k \cap b_k$.
