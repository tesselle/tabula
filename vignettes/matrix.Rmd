...
Methods for a variety of functions applied to objects from these classes provide tools for analysis, seriation and dating of archaeological assembalges. See `help(methods)` to list all available methods for these classes.
