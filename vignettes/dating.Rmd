...
set.seed(12345)
dates <- zuni_mcd$date
dates[sample(1:420, 320, FALSE)] <- NA

## Model the event and accumulation date for each assemblage
model <- date_event(zuni_counts, dates = dates, cutoff = 90)
summary(model[["model"]])

## Estimate event and accumulation dates
event <- predict_event(model, zuni_counts, level = 0.95)
...
refined_boot <- refine_event(model, method = "bootstrap", n = 1000)
head(refined_boot)
```
