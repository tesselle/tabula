...
**tabula** uses a set of S4 classes that extend the basic `matrix` data type. These new classes represent different special types of matrix:
...
These new classes are of simple use, please refer to the documentation of the [**arkhe**](https://github.com/nfrerebeau/arkhe) package where these classes are defined.
...
The Frequency Increment Test can be used to assess the detection and quantification of selective processes in the archaeological record^[Adapted from Ben Marwick's original [idea](https://github.com/benmarwick/signatselect/).].
