...
Spot matrix (easier to read than a heatmap [^2]) allows direct examination of data (above/below some threshold):
...
[^1]: Desachy, B. (2004). Le sériographe EPPM : un outil informatisé de sériation graphique pour tableaux de comptages. *Revue archéologique de Picardie*, 3(1), 39-56. DOI: .
