...
Matrix plot is displayed as a heatmap. The PVI matrix (i.e. B. Desachy's matrigraph PVI) allows to explore deviations from independence (an intuitive graphical approach to $\chi^2$),
