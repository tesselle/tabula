...
[![CRAN checks](https://cranchecks.info/badges/worst/tabula)](https://cran.r-project.org/web/checks/check_results_tabula.html){.pkgdown-release}
...
```{r plot-occ, fig.width=7.5, fig.height=5.5, fig.align="center"}
