...
moths <- .CountMatrix(c(17, 15, 11, 4, 4, 3, 3, 3, 2, 2, 1, 1, 1), nrow = 1)
...
trees <- .CountMatrix(
  c(752, 276, 194, 126, 121, 97, 95, 83, 72, 44, 39,
...
invertebrates <- .CountMatrix(
  c(254, 153, 90, 69, 68, 58, 51, 45, 40, 39, 25, 23, 19, 18, 16, 14, 14,
...
fishes <- rbind(
  `station 1` = c(394, 3487, 275, 683, 22, 1, 0, 1, 6, 8, 1, 1, 2),
  `station 2` = c(1642, 5681, 196, 1348, 12, 0, 1, 48, 21, 1, 5, 7, 3),
  `station 3` = c(90, 320, 180, 46, 2, 0, 0, 1, 0, 0, 2, 1, 5),
  `station 4` = c(126, 17, 115, 436, 27, 0, 0, 3, 1, 0, 0, 1, 0),
  `station 5` = c(32, 0, 0, 5, 0, 0, 0, 0, 13, 9, 0, 0, 4)
)
# Coerce to count matrix
fishes <- as(fishes, "CountMatrix")
